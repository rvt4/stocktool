...
function applyDecisionSystemV29(stocks) {
  for (const stock of stocks) {
    ...
    if (committee) {
      ...
      } else if (stock.rating === 'Strong Buy' && (committee.yesVotes < 4 || committee.fatalNo)) {
    ...
    stock.v27 = {
      version: 'v29-five-member-committee', components,
...
module.exports = { applyDecisionSystemV29, buildActionableReturn, buildActionableMOS };
