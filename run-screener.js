...
async function run(){
  ...
  const output={generatedAt:new Date().toISOString(),count:stocks.length,modelVersion:'simple-v11.2-trust-scope-reconciliation',stocks}; writeJson('results.json',output);
