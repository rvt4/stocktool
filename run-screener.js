...
async function run(){
  ...
  const output={generatedAt:new Date().toISOString(),count:stocks.length,modelVersion:'simple-v12.3-coherent-terminal-economics',stocks}; writeJson('results.json',output);
