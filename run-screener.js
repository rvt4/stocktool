...
async function run(){
  ...
  const output={generatedAt:new Date().toISOString(),count:stocks.length,modelVersion:'simple-v5-cycle-normalized-valuation',stocks}; writeJson('results.json',output);
