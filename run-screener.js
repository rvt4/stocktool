...
async function run(){
  ...
  const output={generatedAt:new Date().toISOString(),count:stocks.length,modelVersion:'simple-v10-audited-intrinsic-value-validation',stocks}; writeJson('results.json',output);
