...
async function run(){
  ...
  const output={generatedAt:new Date().toISOString(),count:stocks.length,modelVersion:'simple-v11-cashflow-reconciliation',stocks}; writeJson('results.json',output);
