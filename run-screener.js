...
async function run(){
  ...
  const output={generatedAt:new Date().toISOString(),count:stocks.length,modelVersion:'simple-v11.10-coherent-margins-balanced-valuation',stocks}; writeJson('results.json',output);
