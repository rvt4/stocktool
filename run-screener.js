...
async function run(){
  ...
  const output={generatedAt:new Date().toISOString(),count:stocks.length,modelVersion:'simple-v12-spreadsheet-operating-model',stocks}; writeJson('results.json',output);
