...
async function run(){
  ...
  const output={generatedAt:new Date().toISOString(),count:stocks.length,modelVersion:'simple-v12.4-economic-method-selection',stocks}; writeJson('results.json',output);
