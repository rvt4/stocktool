...
// V12.55.3 historical identity regression -----------------------------------
const {chooseFigi:chooseHistoricalIdentityFigi}=require('./historical-security-identity-audit');
assert.strictEqual(chooseHistoricalIdentityFigi({data:[
  {ticker:'ABC1',marketSector:'Equity',securityType2:'Future',exchCode:'US'},
  {ticker:'ABC',marketSector:'Equity',securityType2:'Common Stock',exchCode:'US'}
